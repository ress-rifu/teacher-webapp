  ...
  return (
    <Popover>
      <PopoverTrigger asChild>        <Button
          variant={"outline"}
          className={cn(
            "w-full h-10 justify-start text-left font-normal bg-white border border-gray-200 hover:border-indigo-400 focus:border-indigo-500 shadow-sm transition-colors",
        ...
        <Calendar
          ...
          classNames={{
            ...
            day: "h-9 w-9 p-0 font-normal hover:bg-indigo-50 hover:text-indigo-700 rounded-full transition-colors",
            ...
            nav_button: "bg-white hover:bg-indigo-50 hover:text-indigo-700 text-gray-500 transition-colors",
